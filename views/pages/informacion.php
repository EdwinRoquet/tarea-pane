...
$infoMostrar = InformacionControlador::ctrMostarRegistroInfo(null, null);
...
<h3 class=" text-center text-secondary">Administración de información</h3>
...
$info = InformacionControlador::ctrRegistroInfo();
...
<?php
                  $eliminar = new InformacionControlador;
    ...
    <tbody>
        ...
        ?>
            ...
            <td>
             <div class="btn-group">
                 <a href="index.php?page=edit-info&id=<?php echo $value['id']; ?>" class="btn btn-warning m-1"> <i class="fas fa-pencil-alt text-white"></i></a>
                 
                 <form method="post">
                 <input type="hidden" value="<?php echo $value['id']; ?>" name="id_info"> 
